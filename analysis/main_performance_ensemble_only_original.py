...
from performance_functions_original import (baseflow_index, bias, flow_duration_curve,
...
# load ensemble file
fname = f"results_data/{experiment}_{note}.pkl"
...
for basin in ens_dict:
    ...
    e_fhv_2 = FHV(ens_dict[basin], 2) # yhwang 20240616
    e_fhv_5 = FHV(ens_dict[basin], 5) # yhwang 20240616
    e_fhv_10 = FHV(ens_dict[basin], 10) # yhwang 20240616
